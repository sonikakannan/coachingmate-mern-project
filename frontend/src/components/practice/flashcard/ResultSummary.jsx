...
const ResultSummary = ({ courseTitle, correctCount, wrongCount, total }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-indigo-200 p-6 overflow-y-auto">
      <h2 className="text-3xl font-bold text-center text-indigo-700 mb-8">Flashcard Summary</h2>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 max-w-xl mx-auto flex flex-col items-center">
        ...
        <p className="text-gray-600 text-lg mb-4 text-center">
          Your score is{' '}
          <span className="text-indigo-600 font-bold">{resultProgress.toFixed(0)}%</span> correct answers.
        </p>

        <div className="text-center  rounded-lg  px-6 py-4 w-full mt-4">
          <p className="text-lg font-semibold text-gray-700 mb-2">Course: <span className="text-indigo-700">{courseTitle}</span></p>
       ...
       <div className="my-6">
              <Link to={'/practice/flashcard'} className='w-full mx-auto max-w-2xl bg-indigo-500 text-white rounded-lg py-3 px-2 flex justify-center'>
