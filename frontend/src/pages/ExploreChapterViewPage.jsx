      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-6">
          ...
          {chapter.content[currentContentIndex]?.code && (
            <div className="relative bg-gray-100 p-4 rounded overflow-x-auto">
              <button
                onClick={() =>
                  handleCopy(chapter.content[currentContentIndex].code)
                }
                className="absolute top-2 right-2 text-gray-600 hover:text-gray-900"
                title="Copy Code"
              >
                <FaRegCopy className="cursor-pointer text-lg m-5" />
              </button>
